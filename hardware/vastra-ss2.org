...
found [[https://github.com/codetheweb/tuyapi/blob/master/docs/SETUP.md][in the tuyapi project]]. You own Python code can be integrated with the Tuya cloud using their OpenAPI REST API, the following short example will be referenced:
